...
const ClientReview = ({ testImg }) => {
    ...
    return (
        <div className='testimonial_testi_clints'>

            <Slider {...settings}>
                {testimonials.map(testimonial => (
                    <div key={testimonial.id} className='client_review'>
                        <Row>
                            <Col md={6}>
                                <div class="content">
                            ...
                            <Col md={6}>
                                <div class="content">
                                <Typography>Satisfied Clients Say</Typography>
                                    <span class="icon">“</span>
                                    <p class="text">Lorem Ipsum simpy dummy
                                        text of the printing and types
                                        industry has been the industr
